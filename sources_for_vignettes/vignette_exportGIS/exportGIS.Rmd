...
knitr::opts_chunk$set(global.par=TRUE, width="\\linewidth", fig.align="center", dev="CairoPNG", dpi=500) # use dpi=100 for small pdfs
docache <- FALSE
```
...
elevationraster <- elevationrastersmall
