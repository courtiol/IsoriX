...
```{r plot predVar, fig.show = "hold", out.width = "0.5\\linewidth"}
...
```{r plot mean diff}
plotdiff <- plot(x = isoscape.diff, plot = FALSE)  ## We create the plot
