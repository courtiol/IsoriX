...
```{r plot EuropeIsoscape fake, eval = FALSE, results = FALSE}
plot(EuropeIsoscape)
```

```{r plot EuropeIsoscape real, echo = FALSE, results = FALSE}
PlotMean <- plot(EuropeIsoscape, plot = FALSE)
...
```{r plot residVar fake, eval = FALSE, results = FALSE}
plot(EuropeIsoscape, which = "mean_residVar")
```

```{r plot residVar real, echo = FALSE, results = FALSE}
PlotResidVar <- plot(EuropeIsoscape, which = "mean_residVar", plot = FALSE)
...
```{r plot predVar fake, eval = FALSE, results = FALSE}
plot(EuropeIsoscape, which = "mean_predVar")
```

```{r plot rpredVar real, echo = FALSE, results = FALSE}
PlotPredVar <- plot(EuropeIsoscape, which = "mean_predVar", plot = FALSE)
...
```{r plot EuropeIsoscape2 fake, eval = FALSE, results = FALSE}
plot(EuropeIsoscape,
...
```{r plot EuropeIsoscape3 real, echo = FALSE, results = FALSE, include = FALSE}
...
```{r image EuropeIsoscape3, fig.align = 'center', echo = FALSE, cache = FALSE}
