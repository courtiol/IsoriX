...
knitr::opts_chunk$set(cache = FALSE, cache.path = "./cache/cache_knitr/isoscape/", fig.path = "./cache/fig_knitr/isoscape/", global.par = TRUE, fig.align = "center", error = TRUE)
library(IsoriX)
library(knitr)
library(kableExtra)
```
...
The column `mean_source_value` gives the average accross months and years.
...
The column `mean_source_value` gives the average for each month accross the years.
