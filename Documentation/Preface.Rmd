...
Specifically, it uses the package [_spaMM_](http://kimura.univ-montp2.fr/~rousset/spaMM.htm) for fitting and predicting isoscapes, and for performing the assignment.
