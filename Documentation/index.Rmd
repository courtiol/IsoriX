...
The chapters 1 to 5 are almost complete but you will have to wait for the other chapters to follow.

```{r image_intro, echo = FALSE, dev = 'CairoPNG', animation.hook = 'gifski', interval = 3, fig.with = 6}
