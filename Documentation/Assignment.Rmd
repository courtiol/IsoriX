...
It is important that you understand how it works because it has bearing on how you will interpret the assingment results.
...
To do this, we use the difference between these two isocape values as test statistics.
