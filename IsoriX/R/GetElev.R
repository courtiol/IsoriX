GetElev <- function (
  ...
  address.elev <- "http://62.141.164.7/download/elevation_raster_gmted2010_30mn.tif"
  filename.elev <- "elevation_raster_gmted2010_30mn.tif"
  
  ## Define md5sum
  ## (created with tools::md5sum("elevation_raster_gmted2010_30mn.tif"))
