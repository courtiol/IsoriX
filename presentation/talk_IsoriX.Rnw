...
{\scriptsize See details in bookdown, section 6.3.3.}
\end{itemize}
\vfill
\pause
Issue: 
...
\vfill
\item Autmatised the weighting the isoscape by precipitation amount.
\vfill
...
\vfill
\pause
\item What would you prefer? Anything other suggestions?
\end{itemize}
\end{frame}
