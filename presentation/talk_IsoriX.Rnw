...
<<all in one, size = "scriptsize">>=
## GNIPDataEUagg is readily available in IsoriX (already prepared)
...
\begin{frame}[t, fragile]{Where does the bat Nnoc\_15 comes from?}
<<all_in_one_plot, out.height = "7.5cm", out.width = "7.5cm", size = "scriptsize">>=
plot(Assigned15)
@
\end{frame}
